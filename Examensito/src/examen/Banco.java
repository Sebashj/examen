...
public class Banco {
	...
	public void verDatos() {
		cliente = listaClientes.get(cboCliente.getSelectedIndex());
	...
	private void initialize() {
		...
		cboMovimiento.setModel(new DefaultComboBoxModel(new String[] { "retiro", "depocito" }));
		...
		btnAgregarMovimiento.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				monto = m.getTipoMovimiento().equals("depocito") ? monto : (monto * -1);
				m.setMonto(monto);
				cuenta.addMovimiento(m);
				verMovimientos();
			}
