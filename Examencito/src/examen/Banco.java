...
public class Banco {
	...
	private void initialize() {
		...
		frmExamen.setIconImage(Toolkit.getDefaultToolkit().getImage(Banco.class.getResource("/Img/perrocecy.jpg")));
		...
		btnagredar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String tipoCuenta = JOptionPane.showInputDialog("TIPO DE CUENTA");
		...
		btnagregarcuenta.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				m.setMonto(Double.parseDouble(txtmonto.getText().toString()));
		...
		cboMovimiento.setModel(new DefaultComboBoxModel(new String[] {"depocito", "retiro"}));
		cboMovimiento.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				verMovimientos();
				verDatos(); 
			}
		...
		table.setModel(
				new DefaultTableModel(
						...
						new String[] { "Cuenta", "Fecha", "Tipo", "Monto" }));
